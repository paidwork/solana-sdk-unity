...
namespace worken_api.Controllers
{
    ...
    public class TransactionsController : Controller
    {
        ...
        public async Task<IActionResult> CreateTransaction([FromBody] CreateTransactionRequest transactionRequest)
        {
            ...
            var transactionData = transactionsService.CreateTransaction(fromAccount, toAccount, blockHash, transactionRequest.LamPorts, transactionRequest.Memo);
        ...
        public async Task<IActionResult> CreateTransactionWithBurn([FromBody] CreateTransactionBurnRequest transactionRequest)
        {
            ...
            var transactionData = transactionsService.CreateTransactionAndBurn(fromAccount, toAccount, blockHash, transactionRequest.LamPorts, transactionRequest.LamPortsBurn, transactionRequest.Memo);
        ...
        public async Task<IActionResult> CreateBurn([FromBody] CreateBurnRequest burnRequest)
        {
            ...
            var transactionData = transactionsService.CreateBurn(fromAccount,blockHash, burnRequest.Amount, burnRequest.Memo);
            var transactionHash = await rpcService.SendTransaction(client, transactionData);
